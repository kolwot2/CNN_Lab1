...
* **Анализ полученных результатов**: Как и в предыдущем случае, наблюдается переобучение нейронной сети. Причины остаются теми же. Также наблюдается повышение метрики точности в измененной нейронной сети. Одной из причин этого может быть измененная архитектура нейронной сети.   
## Ссылки.
