...
def build_model():
  ...
  x = tf.keras.layers.Conv2D(filters=10, kernel_size=3)(x)
  x = tf.keras.layers.MaxPool2D()(x)
  x = tf.keras.layers.Conv2D(filters=12, kernel_size=3)(x)
  x = tf.keras.layers.MaxPool2D()(x)
  x = tf.keras.layers.Conv2D(filters=14, kernel_size=3)(x)
  x = tf.keras.layers.AveragePooling2D()(x)
  x = tf.keras.layers.Conv2D(filters=16, kernel_size=6)(x)
  x = tf.keras.layers.AveragePooling2D()(x)
