...
def build_model():
  ...
  x = tf.keras.layers.Conv2D(filters=6, kernel_size=3)(inputs)
  x = tf.keras.layers.MaxPool2D()(x)
  x = tf.keras.layers.Conv2D(filters=10, kernel_size=4)(x)
  x = tf.keras.layers.MaxPool2D()(x)
  x = tf.keras.layers.Conv2D(filters=10, kernel_size=7)(x)
  x = tf.keras.layers.AveragePooling2D()(x)
  x = tf.keras.layers.Conv2D(filters=12, kernel_size=5)(x)
  x = tf.keras.layers.AveragePooling2D()(x)
